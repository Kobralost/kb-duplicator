-- [[ Code from https://github.com/Facepunch/garrysmod/pull/1590 ]] --
if not render then return end
KBDuplicator = KBDuplicator or {}
KBDuplicator.Halo = KBDuplicator.Halo or {}
...
function KBDuplicator.Halo.Add( ents, color, mode )
...
function KBDuplicator.Halo.RenderedEntity()
	
	return RenderEnt
	
end

function KBDuplicator.Halo.SetRenderType( render_type )
...
function KBDuplicator.Halo.GetRenderType()
	
	return RenderType
	
end

function KBDuplicator.Halo.SetDoubleThickness( thickness )
...
function KBDuplicator.Halo.IsDoubleThickness()
...
local function RenderOutlines()
	...
	hook.Run( "SetupOutlines", KBDuplicator.Halo.Add )
...
hook.Add( "PreDrawViewModels", "KBDuplicator:Halo:RenderOutlines", function()
...
hook.Add( "PreDrawEffects", "KBDuplicator:Halo:RenderOutlines", function()
...
hook.Add( "PostDrawEffects", "KBDuplicator:Halo:RenderOutlines", function()
